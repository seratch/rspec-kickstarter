...
Gem::Specification.new do |gem|
  ...
  gem.licenses      = ["MIT"]
  gem.description   = %q{rspec-kickstarter supports you writing tests for existing code.}
  gem.summary       = %q{rspec-kickstarter supports you writing tests for existing code.}
